      ...
      <section className="section hero" id="home">
        <div className="container">
          ...
          <div className="hero-content">
            ...
            <p className="hero-subtitle has-before">Wellcome to Our Website</p>

            <h1 className="h1 hero-title">to every 
<i> DIRECTION</i> for you we deliver.</h1>
            ...
            <div className="btn-group">
              <a href="#" className="btn btn-primary">Support More</a>
          ...
          <figure className="hero-banner has-before img-holder" style={{ "--width": 650, "--height": 650}}>
            <img src="/hero-banner.jpg" width="650" height="650" alt="hero banner" className="img-cover" />
          </figure>
